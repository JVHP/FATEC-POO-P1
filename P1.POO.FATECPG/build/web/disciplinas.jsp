...
<html>
    ...
    <body>
        ...
        <form>
            ...
            %>
            <input type="text" name="nomeAntigo" value="<%= nome%>">
            ...
            Nota: <input type="number" step="0.01" min="0" max="10" name="nota" value="<%= nota%>">
        ...
        <%}else{%>
        <form>
            <input type="submit" name="prepInsert" value="Inserir Disciplina">
        </form> 
        <%}%>   
