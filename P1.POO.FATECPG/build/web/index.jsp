...
<%
    ...
    arrayDisci.setterList(BD);
    arrayDisci.setterList(ENGIII);
    arrayDisci.setterList(POO);
    arrayDisci.setterList(LPIV);
    arrayDisci.setterList(SI);
    arrayDisci.setterList(SOII);
    arrayDisci.setterList(TTG);
    
    if(application.getAttribute("arrayDisci") != null){
        application.getAttribute("arrayDisci");
    }else{
        application.setAttribute("arrayDisci", arrayDisci);
    }
%>
